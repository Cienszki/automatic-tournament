 ...
 */
export type GameState = 'draft' | 'lobby_creating' | 'open' | 'ready' | 'in_progress' | 'finished' | 'cancelled' | 'expired' | 'abandoned' | 'failed';
/** States in which the game still occupies a leased Steam account. */
export declare const ACCOUNT_HOLDING_STATES: readonly GameState[];
/** States from which no further transition is possible. */
export declare const TERMINAL_STATES: readonly GameState[];
...
export declare const PLAYING_SIDES: readonly TeamSide[];
