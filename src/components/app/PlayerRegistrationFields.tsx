...
import type { TeamRegistrationFormData } from "@/lib/definitions"; // Ensure this type is defined

interface PlayerRegistrationFieldsProps {
  form: UseFormReturn<TeamRegistrationFormData>; // Use the full form schema type
  playerIndex: 1 | 2 | 3 | 4 | 5;
}

export function PlayerRegistrationFields({ form, playerIndex }: PlayerRegistrationFieldsProps) {
  const fieldNamePrefix = `player${playerIndex}` as const; // 'player1', 'player2', ...
