...
export const translations = {
  ...
  home: {
    ...
    subtitle: "Turniej z limitem MMR",
    welcomeMessage: "Witamy w Letniej Batalii!",
    featuredContent: "Wyróżnione treści",
    ...
    featuredMatch: "Wyróżniony Mecz",
    recentResult: "Ostatni Wynik",
    fantasyLeader: "Lider Fantasy",
    ...
    becomeStandin: "Zostań rezerwowym",
  ...
  teams: {
    ...
    totalMMR: "Łączne MMR",
    averageMMR: "Średnie MMR",
    matchesPlayed: "Rozegrane mecze",
    winsDrawsLosses: "Wygrane / Remisy / Przegrane",
    topHeroes: "Najlepsze bohaterowie",
    avgMatchDuration: "Średni czas meczu",
    ...
    needStandin: "Potrzebujesz rezerwowego?",
    nextMatch: "Następny Mecz",
    noUpcomingMatches: "Brak nadchodzących meczów",
    noUpcomingMatchesDesc: "Sprawdź ponownie po losowaniu następnej rundy.",
    ...
    loss: "Przegrana",
    tbd: "Do ustalenia",
    noPastMatches: "Nie znaleziono rozegranych meczów.",
    status: "Status",
    vs: "vs",
    record: "Bilans",
    winsLosses: "Wygrane / Przegrane",
    avgDuration: "Śr. Czas Trwania",
    averageMatchLength: "Średni czas meczu",
    avgKDA: "Śr. KDA",
    teamKDARatio: "Współczynnik KDA drużyny",
    avgKills: "Śr. Zabójstwa",
    killsPerGame: "Zabójstwa na mecz",
    avgDeaths: "Śr. Śmierci",
    deathsPerGame: "Śmierci na mecz",
    avgAssists: "Śr. Asysty",
    assistsPerGame: "Asysty na mecz",
    avgFantasyPts: "Śr. Pkt Fantasy",
    teamFantasyTotal: "Suma punktów fantasy drużyny",
    gamesPlayed: "rozegranych gier",
    perfect: "Idealny",
    min: "min",
    
    // No Team Found page
    assembleTeam: "Zbierz swoją drużynę, kapitanie!",
    assembleTeamDesc: "Pole bitwy czeka na twoją strategię. Zarejestruj swoją drużynę, aby zarządzać składem, planować mecze i prowadzić swoich graczy do zwycięstwa.",
    takeFirstStep: "Zrób pierwszy krok w stronę mistrzostwa.",
    createYourTeam: "Stwórz swoją drużynę",
    
    // Roster
    teamRoster: "Skład drużyny",
    noTeamData: "Brak danych drużyny.",
    
    // Player Analytics
    playerAnalytics: "Analiza Graczy",
    playerAnalyticsDesc: "Najedź na nagłówki kolumn, aby zobaczyć opisy statystyk.",
    kda: "KDA",
    kdaDesc: "Współczynnik Zabójstw, Śmierci, Asyst ((K+A)/D)",
    killParticipation: "KP%",
    killParticipationDesc: "Procent Udziału w Zabójstwach",
    gpm: "GPM",
    gpmDesc: "Złoto Na Minutę",
    xpm: "XPM", 
    xpmDesc: "Doświadczenie Na Minutę",
    lastHitsMin: "LH/min",
    lastHitsMinDesc: "Ostatnie Uderzenia Na Minutę",
    heroDamageMin: "HD/min",
    heroDamageMinDesc: "Obrażenia Bohatera Na Minutę",
    towerDamageMin: "TD/min",
    towerDamageMinDesc: "Obrażenia Wież Na Minutę",
    wardsMin: "Wardy/min",
    wardsMinDesc: "Postawione Wardy Na Minutę",
    stunsMin: "Ogłuszenia/min",
    stunsMinDesc: "Czas Ogłuszeń Na Minutę",
    heroHealingMin: "Lecz./min",
    heroHealingMinDesc: "Leczenie Bohaterów Na Minutę",
    deniesMin: "Deny/min", 
    deniesMinDesc: "Deny Na Minutę",
    wardKills: "Znisz. Wardy",
    wardKillsDesc: "Zniszczone Observer Wardy",
    stacks: "Stacki",
    stacksDesc: "Zestackowane Obozy",
    noPlayerData: "Brak danych gracza.",
    
    // Scheduling
    scheduleVs: "Zaplanuj vs",
    roundDeadline: "Termin Rundy",
    deadlineApproaching: "Zbliża się termin! Uzgodnij czas, aby uniknąć domyślnego.",
    deadlinePassed: "Termin minął. Planowanie jest zablokowane.",
    standinsAssigned: "Przypisani rezerwowi na ten mecz",
    officialMatchTime: "Oficjalny Czas Meczu",
    notYetScheduled: "Jeszcze nie zaplanowany. Domyślnie",
    pickDate: "Wybierz datę",
    setTime: "Ustaw Czas (format 24h)",
    done: "Gotowe",
    proposeTime: "Zaproponuj Czas",
    selectedTimeAfterDeadline: "Wybrany czas jest po terminie meczu.",
    youProposedTime: "Zaproponowałeś nowy czas!",
    waitingForResponse: "Czekanie na odpowiedź",
    cancelProposal: "Anuluj Propozycję",
    proposedNewTime: "zaproponował nowy czas:",
    proposalInvalid: "Ta propozycja jest nieprawidłowa, ponieważ jest po terminie.",
    accept: "Akceptuj",
    reject: "Odrzuć",
    
    // Toast messages
    notAuthenticated: "Nie uwierzytelniono",
    mustSignIn: "Musisz być zalogowany.",
    success: "Sukces!",
    actionFailed: "Akcja nie powiodła się",
    unexpectedError: "Wystąpił nieoczekiwany błąd",
    invalidTime: "Nieprawidłowy czas",
    cannotProposeAfterDeadline: "Nie można zaproponować czasu po terminie.",
    cannotAcceptPastDeadline: "Nie można zaakceptować czasu, który przekracza termin."
  },
  ...
  players: {
    ...
    losses: "Przegrane",
    winRate: "Wskaźnik wygranych",
    averageKills: "Średnie zabójstwa",
    averageDeaths: "Średnie śmierci", 
    averageAssists: "Średnie asysty",
    kdaRatio: "Stosunek KDA",
    gpm: "Złoto na minutę",
    xpm: "Doświadczenie na minutę",
    lastHits: "Ostatnie uderzenia",
    denies: "Zaprzeczenia",
    heroDamage: "Obrażenia bohaterów",
    towerDamage: "Obrażenia wież",
    heroHealing: "Leczenie bohaterów",
    fantasyPoints: "Punkty fantasy",
    roles: {
      "Carry": "Carry",
      "Mid": "Mid", 
      "Offlane": "Offlane",
  ...
  schedule: {
    title: "Harmonogram",
    description: "Zobacz nadchodzące gry i wyniki meczów.",
    matches: "Mecze",
    match: "Mecz",
    date: "Data",
    time: "Czas",
    ...
    radiant: "Radiant",
    dire: "Dire",
    upcomingGames: "Nadchodzące Gry",
    recentResults: "Ostatnie Wyniki",
    noUpcomingMatches: "Brak Nadchodzących Meczów",
    noUpcomingMatchesDesc: "Nie ma zaplanowanych potwierdzonych meczów.",
    noRecentMatches: "Brak Ostatnich Meczów",
    noRecentMatchesDesc: "Nie ma ostatnio zakończonych meczów do wyświetlenia."
  },

  // Standins
  standins: {
    title: "Zawodnicy Rezerwowi", 
    standin: "Rezerwowy",
    standins: "Rezerwowi",
    requestStandin: "Zgłoś rezerwowego",
    requestStandinTitle: "Zgłoszenie Rezerwowego",
    requestStandinDescription: "Wybierz mecz, graczy niedostępnych i rezerwowych dla Twojej drużyny",
    chooseMatch: "Wybierz mecz",
    selectUnavailablePlayersTitle: "Wybierz niedostępnych graczy (max 2)",
    selectUnavailablePlayersDescription: "Zaznacz graczy, którzy nie będą dostępni na mecz",
    chooseStandins: "Wybierz rezerwowych",
    cancelStandin: "Anuluj Rezerwowego",
    standinRequested: "Rezerwowy Poproszony",
    standinApproved: "Rezerwowy Zatwierdzony",
    standinCancelled: "Zgłoszenie rezerwowego zostało anulowane.",
    standinsAssigned: "Rezerwowi zostali przydzieleni do meczu. Odśwież stronę, aby zobaczyć aktualizacje.",
    standinRequestCancelled: "Zgłoszenie rezerwowego zostało anulowane. Twoi pierwotni gracze mogą teraz uczestniczyć.",
    standinRequestFailed: "Nie udało się wysłać zgłoszenia rezerwowego.",
    cancelStandinFailed: "Nie udało się anulować zgłoszenia rezerwowego",
    notAuthenticated: "Nie jesteś zalogowany",
    mustSignIn: "Musisz się zalogować.",
    unknownPlayer: "Nieznany Gracz", 
    unknownStandin: "Nieznany Rezerwowy",
    unknown: "Nieznane",
    player: "Gracz",
    more: "więcej",
    ...
    error: "Błąd",
    loading: "Ładowanie...",
    noMatchesAvailable: "Brak dostępnych meczów",
    noMatchesDescription: "Nie ma meczów oczekujących na zaplanowanie dla Twojej drużyny.",
    noUpcomingMatches: "Brak nadchodzących meczów",
    totalMMR: "Łączne MMR",
    mmrExceeded: "PRZEKROCZONY LIMIT!",
    noEligibleStandins: "Brak dostępnych rezerwowych spełniających wymogi MMR",
    next: "Dalej",
    cancel: "Anuluj"
  },
  ...
  groups: {
    ...
    losses: "Przegrane",
    goalsFor: "Bramki za",
    goalsAgainst: "Bramki przeciw",
    goalDifference: "Różnica bramek",
    form: "Forma",
    qualified: "Zakwalifikowany",
    eliminated: "Wyeliminowany",
    notFormedYet: "Grupy Jeszcze Nie Utworzone",
  ...
  fantasy: {
    ...
    joinLeague: {
      ...
      description: "Zaloguj się, aby stworzyć swoją drużynę."
    },
    buildTeam: {
      title: "Stwórz Swoją Drużynę",
    ...
    messages: {
      playerAlreadySelected: "Gracz Już Wybrany",
      playerAlreadySelectedDescription: "Ten gracz jest już w innej pozycji w twoim składzie.",
      success: "Sukces!",
      lineupSaved: "Twój skład fantasy został zapisany.",
      error: "Błąd",
      failedToSave: "Nie udało się zapisać składu.",
      failedToSaveDiscord: "Nie udało się zapisać nazwy użytkownika Discord.",
      failedToLoadData: "Nie udało się załadować danych fantasy",
      unknownError: "Nieznany błąd"
    },
    // Legacy flat keys for backward compatibility
    myTeam: "Moja drużyna",
    buildYourTeam: "Zbuduj swoją drużynę",
  ...
  pickem: {
    ...
    points: "Punkty",
    correctPredictions: "Poprawne przewidywania",
    howToPlay: "Jak grać",
    rules: "Zasady",
    deadline: "Termin",
    locked: "Zablokowane",
    ...
    champion: "Mistrz",
    runnerUp: "Drugie miejsce",
    thirdPlace: "3. miejsce",
    fourthPlace: "4. miejsce",
    fifthToSixth: "5. - 6. miejsce",
    seventhToEighth: "7. - 8. miejsce",
    ninthToTwelfth: "9. - 12. miejsce",
    thirteenthToSixteenth: "13. - 16. miejsce",
    groupStageElimination: "Eliminacja w fazie grupowej",
    dragToPredict: "Przeciągnij zespoły do pozycji, aby przewidzieć wyniki turnieju",
    signInToPredict: "Zaloguj się, aby dokonać przewidywań",
    savePredictions: "Zapisz Przewidywania",
    resetPredictions: "Resetuj Przewidywania",
    downloadPredictions: "Pobierz Przewidywania",
    predictionsSaved: "Przewidywania zostały zapisane!",
    errorSavingPredictions: "Błąd podczas zapisywania przewidywań",
  ...
  stats: {
    title: "Statystyki",
    description: "Kompleksowe statystyki i tabele wyników turnieju",
    overview: "Przegląd",
    teams: "Zespoły", 
    players: "Gracze",
    standings: "Tabela",
    ...
    leastDeaths: "Najmniej śmierci",
    mostAssists: "Najwięcej asyst",
    highestGPM: "Najwyższe GPM",
    highestXPM: "Najwyższe XPM",
    mostLastHits: "Najwięcej ostatnich uderzeń",
    mostHeroDamage: "Najwięcej obrażeń bohaterów",
    mostTowerDamage: "Najwięcej obrażeń wież",
    mostHeroHealing: "Najwięcej leczenia bohaterów",
    bestFantasyScore: "Najlepszy wynik fantasy",
    teamStatistics: "Statystyki zespołów",
    playerStatistics: "Statystyki graczy",
    matchStatistics: "Statystyki meczów",
    heroStatistics: "Statystyki bohaterów",
    averageStats: "Średnie statystyki",
    totalMatches: "Łączne mecze",
    totalGames: "Łączne gry",
    completed: "ukończone",
    totalKills: "Łączne zabójstwa",
    avgPerMatch: "śr./mecz",
    avgMatchDuration: "Śr. czas meczu",
    minutes: "minut",
    totalFantasyPoints: "Łączne pkt fantasy",
    playerRecords: "Rekordy graczy",
    teamRecords: "Rekordy drużyn",
    metaStats: "Statystyki meta",
    topFantasyPerformers: "Najlepsi gracze fantasy",
    mostDenies: "Najwięcej zaprzeczenia",
    longestKillStreak: "Najdłuższa seria zabójstw",
    teamRankings: "Ranking drużyn",
    avgMatch: "śr. mecz",
    fastestVictory: "Najszybsze zwycięstwo",
    highestTeamKills: "Najwięcej zabójstw drużyny",
    perfectGames: "Perfekcyjne gry",
    mostPickedHero: "Najczęściej wybierany bohater",
    mostBannedHero: "Najczęściej banowany bohater",
    highestWinrateHero: "Bohater z najwyższym WR",
    radiantWinRate: "Współczynnik zwycięstw Radiant",
    picks: "wyborów",
    bans: "banów",
    matches: "mecze",
    averageGameDuration: "Średni czas gry",
    killsPerGame: "Zabójstwa na grę",
    deathsPerGame: "Śmierci na grę",
    assistsPerGame: "Asysty na grę",

    // New comprehensive stats
    activeTeams: "Aktywne drużyny",
    radiantWins: "Zwycięstwa Radiant",
    direWins: "Zwycięstwa Dire",
    avgTeamFight: "Śr. starcie drużyn",
    mostPicks: "Najwięcej wyborów",
    mostBans: "Najwięcej banów",

    // MVP Categories
    tournamentMVP: "MVP Turnieju",
    supportMVP: "MVP Wsparcia",
    carryMVP: "MVP Carry",
    dominanceKing: "Król Dominacji",
    darkHorse: "Czarny Koń",
    bestDraft: "Najlepszy Draft",

    // Combat Performance
    combatPerformance: "Wydajność Bojowa",
    mostKillsTooltip: "Najwięcej zabójstw w pojedynczym meczu",
    mostAssistsTooltip: "Najwięcej asyst w pojedynczym meczu",
    highestKDATooltip: "Najwyższy stosunek Kill/Death/Assist",
    mostHeroDamageTooltip: "Najwięcej obrażeń zadanych bohaterom przeciwnika",
    mostHeroHealingTooltip: "Najwięcej punktów zdrowia przywróconych sojusznikom",
    mostTowerDamageTooltip: "Najwięcej obrażeń zadanych strukturom przeciwnika",
    highestGPMTooltip: "Najwyższe złoto za minutę (Gold Per Minute)",
    highestXPMTooltip: "Najwyższe doświadczenie za minutę (XP Per Minute)",

    // Farming & Economy
    farmingEconomy: "Farmienie i Ekonomia",
    mostLastHitsTooltip: "Najwięcej ostatnich uderzeń (creepów) w meczu",
    mostDeniesTooltip: "Najwięcej zaprzeczonych ostatnich uderzeń wrogim creepom",
    highestNetWorth: "Najwyższa Wartość Netto",
    highestNetWorthTooltip: "Najwyższa wartość wszystkich przedmiotów i złota gracza",
    mostGoldSpent: "Najwięcej Wydanego Złota",
    mostGoldSpentTooltip: "Największa ilość złota wydana na przedmioty w meczu",
    mostBuybacks: "Najwięcej Wykupów",
    mostBuybacksTooltip: "Najwięcej użyć funkcji wykupu po śmierci",
    fastestMidas: "Najszybszy Midas",
    fastestMidasTooltip: "Najszybsze zdobycie przedmiotu Hand of Midas",
    mostTPScrolls: "Najwięcej Zwojów TP",
    mostTPScrollsTooltip: "Najwięcej zakupionych zwojów teleportacji",
    earliestLevel25: "Najszybszy 25 Poziom",
    earliestLevel25Tooltip: "Najszybsze osiągnięcie maksymalnego poziomu",

    // Support & Vision
    supportVision: "Wsparcie i Wizja",
    mostObserverWards: "Najwięcej Observer Wardów",
    mostObserverWardsTooltip: "Najwięcej postawionych wardów obserwacyjnych",
    mostSentryWards: "Najwięcej Sentry Wardów",
    mostSentryWardsTooltip: "Najwięcej postawionych wardów wykrywających",
    mostObserverKills: "Najwięcej Zabójstw Observer",
    mostObserverKillsTooltip: "Najwięcej zniszczonych wardów obserwacyjnych przeciwnika",
    mostSentryKills: "Najwięcej Zabójstw Sentry",
    mostSentryKillsTooltip: "Najwięcej zniszczonych wardów wykrywających przeciwnika",
    mostCampsStacked: "Najwięcej Camp Stacków",
    mostCampsStackedTooltip: "Najwięcej zgrupowanych obozów neutralnych",
    mostRunesCollected: "Najwięcej Run",
    mostRunesCollectedTooltip: "Najwięcej zebranych run mocy",
    highestAPM: "Najwyższe APM",
    highestAPMTooltip: "Najwyższe akcje na minutę (Actions Per Minute)",
    longestStun: "Najdłuższy Stun",
    longestStunTooltip: "Najdłuższy czas ogłuszenia zadany przeciwnikowi",

    // Special Achievements
    specialAchievements: "Specjalne Osiągnięcia",
    longestKillStreakTooltip: "Najdłuższa seria zabójstw bez śmierci",
    mostCourierKills: "Najwięcej Zabójstw Kuriera",
    mostCourierKillsTooltip: "Najwięcej zniszczonych kurierów przeciwnika",
    mostRoshanKills: "Najwięcej Zabójstw Roshana",
    mostRoshanKillsTooltip: "Najwięcej zabójstw bossa Roshana",
    mostVersatile: "Najbardziej Wszechstronny",
    mostVersatileTooltip: "Gracz używający największej liczby różnych bohaterów",
    mostNeutralKills: "Najwięcej Zabójstw Neutralnych",
    mostNeutralKillsTooltip: "Najwięcej zabitych stworzeń neutralnych",
    mostAncientKills: "Najwięcej Zabójstw Pradawnych",
    mostAncientKillsTooltip: "Najwięcej zabitych pradawnych stworzeń",
    fastestAghanims: "Najszybszy Aghanim's",
    fastestAghanimsTooltip: "Najszybsze zdobycie Aghanim's Scepter",
    totalRampagesCount: "Łączne Rampages",
    totalRampagesCountTooltip: "Łączna liczba pentakilli (5 zabójstw z rzędu)",

    // Team Combat Records
    teamCombat: "Rekordy Bojowe Drużyn",
    mostTeamKillsTooltip: "Najwięcej zabójstw drużyny w pojedynczym meczu",
    fewestDeaths: "Najmniej Śmierci",
    fewestDeathsTooltip: "Najmniejsza liczba śmierci drużyny w meczu",
    highestTeamKDA: "Najwyższe KDA Drużyny",
    highestTeamKDATooltip: "Najlepszy stosunek zabójstw/śmierci/asyst drużyny",
    mostTeamAssists: "Najwięcej Asyst Drużyny",
    mostTeamAssistsTooltip: "Największa liczba asyst całej drużyny w meczu",
    mostFirstBloods: "Najwięcej Pierwszych Krwi",
    mostFirstBloodsTooltip: "Najwięcej zdobytych pierwszych zabójstw w meczach",

    // Team Economy
    teamEconomy: "Ekonomia Drużyny",
    highestTeamGPM: "Najwyższe GPM Drużyny",
    highestTeamGPMTooltip: "Najwyższa średnia złota na minutę całej drużyny",
    highestTeamXPM: "Najwyższe XPM Drużyny", 
    highestTeamXPMTooltip: "Najwyższa średnia doświadczenia na minutę drużyny",
    biggestNetWorthLead: "Największa Przewaga Ekonomiczna",
    biggestNetWorthLeadTooltip: "Największa różnica wartości netto między drużynami",
    mostGoldEarned: "Najwięcej Zarobionego Złota",
    mostGoldEarnedTooltip: "Największa ilość złota zarobiona przez drużynę w meczu",
    mostTotalXP: "Najwięcej Łącznego XP",
    mostTotalXPTooltip: "Największa ilość doświadczenia zdobyta przez drużynę",

    // Team Vision
    teamVision: "Wizja i Kontrola Mapy",
    mostWardsKilled: "Najwięcej Zniszczonych Wardów",
    mostWardsKilledTooltip: "Największa liczba zniszczonych wardów przeciwnika",
    mostRunesSecured: "Najwięcej Zabezpieczonych Run",
    mostRunesSecuredTooltip: "Największa liczba zebranych run przez drużynę",
    highestTeamAPM: "Najwyższe APM Drużyny",
    highestTeamAPMTooltip: "Najwyższa średnia akcji na minutę drużyny",

    // Team Objectives
    teamObjectives: "Cele i Struktury",
    fastestVictoryTooltip: "Najkrótszy czas potrzebny na zwycięstwo",
    mostTowerKills: "Najwięcej Zniszczonych Wież",
    mostTowerKillsTooltip: "Największa liczba zniszczonych wież przeciwnika",
    mostBarracks: "Najwięcej Koszar",
    mostBarracksTooltip: "Największa liczba zniszczonych koszar",
    perfectGamesTooltip: "Liczba meczów wygranych bez straty żadnej struktury",
    mostTeamfightsWon: "Najwięcej Wygranych Starć",
    mostTeamfightsWonTooltip: "Największa liczba wygranych walk drużynowych",

    // Tournament Overview
    tournamentOverview: "Przegląd Turnieju",
    totalTeams: "Łączne Drużyny",
    totalTeamsTooltip: "Całkowita liczba zarejestrowanych drużyn",
    matchesCompleted: "Ukończone Mecze",
    matchesCompletedTooltip: "Liczba rozegranych i zakończonych meczów",
    totalGamesTooltip: "Całkowita liczba rozegranych gier",
    avgMatchDurationTooltip: "Średni czas trwania meczu w turnieju",
    longestMatch: "Najdłuższy Mecz",
    longestMatchTooltip: "Mecz o najdłuższym czasie trwania",
    shortestMatch: "Najkrótszy Mecz", 
    shortestMatchTooltip: "Mecz o najkrótszym czasie trwania",
    radiantWinRateTooltip: "Procent zwycięstw drużyn grających po stronie Radiant",
    direWinRateTooltip: "Procent zwycięstw drużyn grających po stronie Dire",

    // Tournament Combat
    tournamentCombat: "Statystyki Bojowe Turnieju",
    totalKillsTooltip: "Łączna liczba zabójstw w całym turnieju",
    totalDeaths: "Łączne Śmierci",
    totalDeathsTooltip: "Łączna liczba śmierci w całym turnieju",
    totalAssists: "Łączne Asysty",
    totalAssistsTooltip: "Łączna liczba asyst w całym turnieju",
    totalRampagesTooltip: "Łączna liczba pentakilli w turnieju",
    totalUltraKills: "Łączne Ultra Kille",
    totalUltraKillsTooltip: "Łączna liczba quadrakilli w turnieju",
    firstBloods: "Pierwsze Krwie",
    firstBloodsTooltip: "Liczba pierwszych zabójstw w meczach",
    killsPerGameTooltip: "Średnia liczba zabójstw na mecz",
    bloodiestGame: "Najkrwawszy Mecz",
    bloodiestGameTooltip: "Mecz z największą liczbą zabójstw",
    ...
    mostVersatilePlayerTooltip: "Gracz używający największej liczby różnych bohaterów",
    mostPopularRole: "Najpopularniejsza Rola",
    mostPopularRoleTooltip: "Najczęściej wybierana pozycja na mapie",
    metaShiftCount: "Zmiany Meta",
    metaShiftCountTooltip: "Liczba znaczących zmian w popularności bohaterów",
    sleeperPick: "Zaskakujący Wybór",
    sleeperPickTooltip: "Niespodziewanie skuteczny bohater",

    // Economy & Items
    economyItems: "Ekonomia i Przedmioty",
    totalGoldEarned: "Łączne Zarobione Złoto",
    totalGoldEarnedTooltip: "Całkowita ilość złota zarobiona w turnieju",
    totalGoldSpentTooltip: "Całkowita ilość złota wydana na przedmioty",
    divineRapiers: "Boskie Szpady",
    divineRapiersTooltip: "Liczba zakupionych Divine Rapierów (ryzykowny przedmiot)",
    aghanimsScepters: "Berła Aghanimów",
    aghanimsSceptersTooltip: "Liczba zakupionych Aghanim's Scepterów",
    handOfMidas: "Dłonie Midasa",
    handOfMidasTooltip: "Liczba zakupionych Hand of Midas (przedmiot do farmienia)",
    mostExpensiveItem: "Najdroższy Przedmiot",
    mostExpensiveItemTooltip: "Najdroższy przedmiot zbudowany w turnieju",
    avgGoldPerGame: "Śr. Złoto na Mecz",
    avgGoldPerGameTooltip: "Średnia ilość złota na mecz w turnieju",
    totalBuybacksTooltip: "Łączna liczba wykupów po śmierci",

    // Map Control & Objectives
    mapControlObjectives: "Kontrola Mapy i Cele",
    observerWardsTooltip: "Łączna liczba postawionych wardów obserwacyjnych",
    sentryWardsTooltip: "Łączna liczba postawionych wardów wykrywających",
    roshanKillsTooltip: "Łączna liczba zabójstw bossa Roshana",
    towersDestroyedTooltip: "Łączna liczba zniszczonych wież",
    ancientCreepsTooltip: "Łączna liczba zabitych pradawnych stworzeń",
    runesCollectedTooltip: "Łączna liczba zebranych run mocy",
    visionScore: "Wynik Wizji",
    visionScoreTooltip: "Średni wynik kontroli wizji w turnieju",
    mapControlPercent: "Procent Kontroli Mapy",
    mapControlPercentTooltip: "Średni procent kontroli terytorium",

    // Tooltips for MVP categories
    tournamentMVPTooltip: "Gracz z najwyższym średnim KDA w turnieju",
    supportMVPTooltip: "Gracz z największą liczbą postawionych wardów",
    carryMVPTooltip: "Gracz z najwyższym średnim GPM",
    dominanceKingTooltip: "Drużyna z najdłuższą serią zwycięstw",
    darkHorseTooltip: "Drużyna z największym zaskakującym zwycięstwem",
    bestDraftTooltip: "Kombinacja bohaterów z najwyższym współczynnikiem zwycięstw",

    // Additional explanations
    noData: "Brak danych",
    noDataAvailable: "Brak dostępnych danych",
    calculatingStats: "Obliczanie statystyk...",
    statsWillAppear: "Statystyki pojawią się po rozegraniu meczów"
  },

  // Registration
  registration: {
    title: "Rejestracja zespołu",
    teamRegistration: "Rejestracja zespołu",
    ...
    teamNameRequired: "Nazwa zespołu jest wymagana",
    teamTagRequired: "Tag zespołu jest wymagany",
    playerRequired: "Gracz jest wymagany",
    roleRequired: "Rola jest wymagana",
    steamIDRequired: "Steam ID jest wymagane",
    discordRequired: "Nick Discord jest wymagany",
  ...
  myTeam: {
    title: "Moja Drużyna",
    welcomeCaptain: "Witaj, przyszły kapitanie!",
    ...
    takeFirstStep: "Zrób pierwszy krok i zarejestruj swoją drużynę.",
    registerYourTeam: "Zarejestruj swoją drużynę",
    noUpcomingMatches: "Brak Nadchodzących Meczów",
    noMatchesScheduled: "Twoja drużyna nie ma zaplanowanych meczów.",
    upcomingMatches: "Nadchodzące Mecze",
    matchHistory: "Historia Meczów",
    teamStats: "Statystyki Drużyny",
    playerAnalytics: "Analityka Graczy",
    roster: "Skład",
    teamStatus: "Status Drużyny"
  },
  ...
  rules: {
    ...
    general: {
      ...
      administrator: "Administrator turnieju:",
      administratorName: "Cienszki",
    ...
    registration: {
      title: "2. Rejestracja Drużyn",
      captainDuties: {
        title: "2.1 Obowiązki Kapitana Drużyny",
        description: "Kapitan drużyny odpowiada za:",
        communication: "Komunikację z administracją i pozostałymi uczestnikami turnieju",
        teamRegistration: "Dokonanie rejestracji drużyny na oficjalnej stronie turnieju",
        informationSharing: "Przekazywanie członkom drużyny informacji dotyczących regulaminu, ogłoszeń i kwestii organizacyjnych",
        accountRequirements: "Posiadanie aktywnego konta na stronie turnieju oraz obecność na serwerze Discord PD2IH"
      },
      captainChange: {
        title: "2.2 Zmiana Kapitana",
        description: "W przypadku gdy kapitan nie może wywiązać się ze swoich obowiązków, należy niezwłocznie skontaktować się z administracją w celu wyznaczenia nowego kapitana. Zmiana wymaga zgody wszystkich pozostałych członków drużyny."
      },
      teamComposition: {
        title: "2.3 Drużyna",
    ...
    // MMR Calculator
    mmrCalculator: {
      title: "Kalkulator Limitu MMR",
      player: "Gracz",
      enterMMR: "Wpisz MMR",
      totalTeamMMR: "Łączne MMR drużyny:",
      overCapWarning: "Ta drużyna przekracza limit MMR i nie kwalifikuje się do turnieju."
    },
  ...
  mmrLimit: "Sumaryczne MMR wszystkich 5 graczy w drużynie nie może przekroczyć 24,000 punktów",
    ...
    prohibitions: {
      title: "8. Zakazy i Ograniczenia",
      strictlyForbidden: "Bezwzględnie zakazane:",
      cheating: "Używanie cheatów, zewnętrznych programów",
  ...
  faq: {
    ...
    noResultsDescription: "Spróbuj innych słów kluczowych lub usuń filtry.",
    showingResults: "Pokazuje",
    of: "z",
    questions: "pytań",
    forQuery: "dla zapytania",
    inCategory: "w kategorii",
    questionsAvailable: "dostępnych pytań",
    question: "Pytanie",
    answer: "Odpowiedź",
    helpful: "Czy ta odpowiedź była pomocna?",
    yes: "Tak",
    no: "Nie",
    stillNeedHelp: "Nadal potrzebujesz pomocy?",
    contactSupport: "Skontaktuj się z nami na Discord",
    lastUpdated: "Ostatnia aktualizacja:",
    
    sections: {
      general: "Informacje Ogólne",
      registration: "Rejestracja i Zespoły", 
      gameplay: "Rozgrywka i Zasady",
      scheduling: "Planowanie i Logistyka",
    ...
    registration: {
      ...
      deadline: {
        ...
        answer: "Rejestracja kończy się 13.08.2025 o godzinie 23:59 czasu polskiego. Po tym terminie nie będzie możliwa rejestracja nowych drużyn."
      },
      requirements: {
      ...
      teamChanges: {
        ...
        answer: "Nie, po dokonaniu rejestracji skład drużyny jest ostateczny i nie może być zmieniony. Jedyną opcją są zawodnicy rezerwowi (stand-in) w przypadku problemów."
      },
      standins: {
    ...
    gameplay: {
      ...
      scoring: {
        ...
        answer: "Za mecz BO2: Wygrana 2-0 = 2 punkty, Remis 1-1 = 1 punkt dla każdej drużyny, Przegrana 0-2 = 0 punktów. W przypadku równej liczby punktów decyduje: bezpośredni mecz, system Neustadtl, niższe MMR."
      },
      lobbySettings: {
      ...
      pausing: {
        ...
        answer: "Pauzowanie jest dozwolone zgodnie z regułami Dota 2. Przeciwnik może wznowić po odpowiednim czasie. Zabronione jest nadużywanie pauzy podczas teamfightów lub kluczowych akcji."
      },
      rehosting: {
        question: "Kiedy można rehostować grę?",
        answer: "Tylko w pierwszych 5 minutach gry (od 0:00), za zgodą obu kapitanów, w przypadku: bugów gry, awarii serwera lub problemów z połączeniem gracza."
      },
      cheating: {
        question: "Jaka jest polityka wobec oszukiwania?",
        answer: "Bezwzględnie zakazane: smurfing, multi-accounting, external programy, coaching podczas meczu, exploity/bugi. Konsekwencje: natychmiastowa dyskwalifikacja i ban w przyszłych edycjach."
      },
      conduct: {
        question: "Jaki jest kodeks postępowania?",
        answer: "Oczekiwane: szacunek dla wszystkich, fair play, pozytywna postawa. Zakazane: obrażanie, harassment, trolling na Discord/Twitch, niesportowe zachowanie. Naruszenia mogą skutkować dyskwalifikacją."
      }
    },
    ...
    scheduling: {
      ...
      deadline: {
        ...
        answer: "Jeśli do deadline rundy nie zostanie uzgodniony termin, mecz automatycznie odbędzie się w czasie domyślnym. To jest nieodwołalne - odpowiedzialność leży po stronie kapitanów."
      },
      lateness: {
      ...
      timezone: {
        ...
        answer: "Wszystkie terminy są podawane w czasie polskim (CEST/CET). Strona internetowa automatycznie dostosowuje wyświetlane czasy do Twojej lokalnej strefy czasowej."
      }
    },
    ...
    technical: {
      ...
      mobile: {
        ...
        answer: "Tak, strona jest w pełni responsywna i działa na wszystkich urządzeniach mobilnych. Wszystkie funkcje dostępne, ale zaleca się komputer do rejestracji drużyny."
      },
      data: {
    ...
    communication: {
      ...
      streaming: {
        ...
        answer: "Tak! Zalecane 10-min opóźnienie. Wybrane mecze będą też na oficjalnym kanale Twitch: twitch.tv/polishdota2inhouse. Administracja nie odpowiada za stream sniping."
      },
      languages: {
        question: "W jakim języku jest turniej?",
        answer: "Turniej jest w języku polskim. Strona internetowa, komunikacja Discord, zasady - wszystko po polsku. To turniej dla polskiej społeczności Dota 2."
      }
    },
    ...
    platform: {
      ...
      updates: {
        ...
        answer: "Wyniki meczów, punkty Fantasy, tabele - aktualizowane w czasie rzeczywistym lub w ciągu kilku minut po zakończeniu gry. Statystyki szczegółowe raz dziennie."
      },
      offline: {
        question: "Co jeśli strona nie działa?",
        answer: "Rzadkie awarie są szybko naprawiane. Status strony sprawdzaj na Discord. W przypadku awarii podczas ważnych deadline, terminy mogą być przedłużone."
      }
    }
  },
  ...
  messages: {
    ...
    loginRequiredDesc: "Musisz być zalogowany, aby wykonać tę akcję.",
    notLoggedIn: "Nie jesteś zalogowany",
    notLoggedInDesc: "Musisz być zalogowany, aby zapisywać w bazie danych.",
    saveSuccess: "Zapisano pomyślnie!",
    saveSuccessDesc: "Dane zostały pomyślnie zapisane.",
    saveError: "Błąd zapisu",
    saveErrorDesc: "Wystąpił błąd podczas zapisywania danych.",
    loadError: "Błąd ładowania",
    loadErrorDesc: "Nie udało się załadować danych.",
    connectionError: "Błąd połączenia",
    connectionErrorDesc: "Sprawdź połączenie internetowe i spróbuj ponownie.",
    permissionDenied: "Brak uprawnień",
    permissionDeniedDesc: "Nie masz uprawnień do wykonania tej akcji.",
    dataNotFound: "Nie znaleziono danych",
    dataNotFoundDesc: "Żądane dane nie zostały znalezione.",
    validationError: "Błąd walidacji",
    validationErrorDesc: "Wprowadzone dane są nieprawidłowe.",
    networkError: "Błąd sieci",
    networkErrorDesc: "Wystąpił błąd sieciowy. Spróbuj ponownie później.",
    timeoutError: "Przekroczono limit czasu",
    timeoutErrorDesc: "Żądanie przekroczyło limit czasu. Spróbuj ponownie.",
    unexpectedError: "Nieoczekiwany błąd",
    unexpectedErrorDesc: "Wystąpił nieoczekiwany błąd. Spróbuj ponownie lub skontaktuj się z pomocą techniczną."
  },
  ...
  // Team detail page translations
  teamDetail: {
    teamSummary: "Podsumowanie Drużyny",
    playerRoster: "Skład Gracza",
    topHeroes: "Najczęściej Grani Bohaterowie",
    avgMatchDuration: "Średni Czas Trwania Meczu",
    matchesPlayed: "Rozegrane Mecze",
    winsDrawsLosses: "Zwycięstwa / Remisy / Porażki",
    totalMMR: "Łączne MMR",
    captainDiscord: "Discord Kapitana",
    matchHistory: "Historia Meczów",
    opponent: "Przeciwnik",
    result: "Wynik",
    score: "Punkty",
    ...
    noHeroStats: "Brak statystyk bohaterów dla tej drużyny.",
    noMatchHistory: "Brak historii meczów dla tej drużyny.",
    detailedProfile: "Szczegółowy profil i statystyki wydajności.",
    games: "Gier",
    game: "Gra",
    min: "min",
    
    // Performance stats
    avgKillsPerGame: "Śr. Zabójstwa / Grę",
    avgDeathsPerGame: "Śr. Śmierci / Grę",
    avgAssistsPerGame: "Śr. Asysty / Grę",
    avgFantasyPoints: "Śr. Punkty Fantasy",
    avgGPM: "Śr. GPM",
    avgXPM: "Śr. XPM",
    avgLastHits: "Śr. Ostatnie Uderzenia",
    avgNetWorth: "Śr. Wartość Netto",
    avgHeroDamage: "Śr. Obrażenia Bohaterów",
    avgTowerDamage: "Śr. Obrażenia Wież",
    avgHealing: "Śr. Leczenie",
    
    // Stat descriptions
    goldPerMinute: "Złoto Na Minutę",
    experiencePerMinute: "Doświadczenie Na Minutę",
    creepKills: "Ostatnie Trafienia",
    totalGoldValue: "Łączna Wartość w Złocie",
    damageToHeroes: "Obrażenia Bohaterom",
    damageToBuildings: "Obrażenia Budynkom",
    heroHealingDone: "Leczenie",
    
    // League stats
    leagueAvg: "Śr. turnieju",
    best: "Najlepsze",
    rank: "Pozycja",
    
    // Team status translations
    pending: "Oczekująca",
    verified: "Zweryfikowana",
    warning: "Ostrzeżenie",
    banned: "Zbanowana"
  ...
  playerDetail: {
    backToTeam: "Powrót do",
    memberOf: "Członek",
    recentMatchHistory: "Historia Ostatnich Meczów",
    performanceInMatches: "Występy w meczach turnieju.",
    noMatchData: "Brak danych o występach w meczach.",
    leagueAvg: "Śr. turnieju",
    vs: "przeciwko",
    fantasyPoints: "Punkty Fantasy",
    kdaRatio: "Stosunek KDA",
  ...
  toasts: {
    ...
    success: {
      ...
      fantasy: {
        ...
        lineupSaved: "Skład został zapisany."
      },
      profile: {
        updated: "Profil został zaktualizowany."
      },
      standingsRecalculated: "Tabela grup została przeliczona pomyślnie!"
    },
    
    // Error messages
    errors: {
      title: "Błąd",
      networkError: "Błąd sieci lub serwera.",
      dataFetch: "Błąd pobierania danych",
      loadRequired: "Nie można załadować wymaganych danych.",
      unexpectedStandings: "Wystąpił nieoczekiwany błąd podczas przeliczania tabeli.",
      discordSave: "Nie można zapisać nicku Discord.",
      loadRegistrationPayloads: "Nie można załadować danych rejestracyjnych.",
      
      // Pickem specific
      pickem: {
        failedToSave: "Nie udało się zapisać twoich przewidywań."
      },
      
      // Auth specific
      auth: {
        title: "Błąd uwierzytelniania",
        loginRequired: "Musisz być zalogowany, aby usuwać mecze.",
      ...
      admin: {
        ...
        creationFailed: "Tworzenie nie powiodło się",
        generationFailed: "Generowanie nie powiodło się",
        recalculateStandings: "Nie udało się przeliczyć tabeli"
      },
      
      // Validation specific
      validation: {
        invalidMatchId: "Nieprawidłowe ID meczu",
        numericMatchId: "Proszę wprowadzić numeryczne ID meczu OpenDota.",
        groupNameAndTeam: "Proszę podać nazwę grupy i wybrać przynajmniej jeden zespół.",
        requiredInfo: "Proszę podać wszystkie wymagane informacje."
      }
    },
    
    // Other flat keys for backward compatibility
    saveSuccess: "Zapisano pomyślnie!",
    updateSuccess: "Zaktualizowano pomyślnie!",
    deleteSuccess: "Usunięto pomyślnie!",
    actionCompleted: "Akcja wykonana pomyślnie!",
    saveError: "Błąd zapisu",
    loadError: "Błąd ładowania",
    ...
    loginRequired: "Musisz być zalogowany, aby wykonać tę akcję.",
    insufficientPermissions: "Nie masz wystarczających uprawnień.",
    teamSaved: "Drużyna została zapisana.",
    lineupSaved: "Skład został zapisany.",
    predictionsSaved: "Przewidywania zostały zapisane.",
    profileUpdated: "Profil został zaktualizowany.",
    teamRegistered: "Drużyna została zarejestrowana.",
    matchScheduled: "Mecz został zaplanowany.",
    teamVerified: "Drużyna została zweryfikowana.",
    teamRejected: "Drużyna została odrzucona.",
    matchImported: "Mecz został zaimportowany.",
    standingsRecalculated: "Tabela została przeliczona.",
    groupCreated: "Grupa została utworzona.",
    announcementPublished: "Ogłoszenie zostało opublikowane.",
    invalidData: "Wprowadzone dane są nieprawidłowe.",
    fieldsRequired: "Wszystkie wymagane pola muszą być wypełnione.",
    requiredInfo: "Proszę podać wszystkie wymagane informacje.",
    invalidEmail: "Nieprawidłowy adres email.",
    invalidMMR: "Nieprawidłowa wartość MMR.",
    budgetExceeded: "Przekroczono dostępny budżet.",
    deadlinePassed: "Termin minął.",
    confirmDelete: "Czy na pewno chcesz usunąć?",
    confirmReset: "Czy na pewno chcesz zresetować?",
    ...
    discordRequired: "Wymagany jest nick Discord.",
    discordSaved: "Nick Discord został zapisany.",
    discordError: "Nie można zapisać nicku Discord."
  },
  ...
  errorPages: {
    notFound: {
      ...
      heading: "Ups! Strona nie istnieje",
      description: "Strona, której szukasz, nie została znaleziona. Mogła zostać przeniesiona, usunięta lub nieprawidłowo wpisany jest adres URL.",
      homeButton: "Wróć do strony głównej",
      searchSuggestion: "Spróbuj wyszukać to, czego potrzebujesz:"
    },
    error: {
      title: "Błąd aplikacji",
      heading: "Coś poszło nie tak",
      description: "Wystąpił nieoczekiwany błąd. Zespół techniczny został powiadomiony.",
    ...
    loading: {
      ...
      timeout: "Ładowanie trwa dłużej niż zwykle. Sprawdź połączenie internetowe."
    },
    maintenance: {
      title: "Serwis niedostępny",
      heading: "Trwają prace konserwacyjne",
      description: "Przepraszamy za niedogodności. Serwis jest tymczasowo niedostępny z powodu prac konserwacyjnych.",
      expectedTime: "Przewidywany czas zakończenia: {time}",
      checkBack: "Sprawdź ponownie później"
    },
    forbidden: {
      title: "403 - Dostęp zabroniony",
      heading: "Brak uprawnień",
      description: "Nie masz uprawnień do przeglądania tej strony.",
      loginSuggestion: "Spróbuj się zalogować lub skontaktuj się z administratorem."
    }
  }
};
